...
export function DASHBOARD ({navigation}) {
  	...
  	return (
    		<View style={styles.homeDb}>
      			...
      			<Pressable style={[styles.vectorWrapper, styles.framePosition]} onPress={()=>{}}>
        				<Image style={styles.vectorIcon3} resizeMode="cover" /*source="Vector.png"*/ />
      			</Pressable>
      			<View style={[styles.homeDbItem, styles.homePosition]} />
      			<Pressable style={[styles.beatBookWrapper, styles.wrapperFlexBox]} onPress={()=>{navigation.navigate("BeatBook");}}>
      			...
      			<Text style={[styles.dutiesAssigned, styles.beatBookTypo]} onPress={()=>{navigation.navigate("Profile");}} >DUTIES ASSIGNED</Text>
    		</View>);
};
