  	...
  	return (
    		<View style={styles.directory}>
      			...
      			<Pressable style={styles.vectorWrapper} onPress={()=>{}}>
        				<Image style={styles.vectorIcon7} resizeMode="cover" /*source="Vector.png"*/ />
      			</Pressable>
      			<View style={styles.rectangleView} />
      			<Text style={styles.searchOfficer}>Search officer...</Text>
      			<Image style={styles.searchoutlineIcon} resizeMode="cover" /*source="SearchOutline.png"*/ />
      			<View style={styles.rectangleParent}>
        				...
        				<Image style={[styles.vectorIcon9, styles.vectorIconLayout]} resizeMode="cover" /*source="Vector.png"*/ />
        				<Image style={[styles.vectorIcon10, styles.vectorIconLayout]} resizeMode="cover" /*source="Vector.png"*/ />
        				<Image style={[styles.vectorIcon11, styles.vectorIconLayout]} resizeMode="cover" /*source="Vector.png"*/ />
        				<Image style={[styles.vectorIcon12, styles.vectorIconLayout]} resizeMode="cover" /*source="Vector.png"*/ />
        				<Image style={[styles.vectorIcon13, styles.vectorIconLayout]} resizeMode="cover" /*source="Vector.png"*/ />
